package com.workflow.internet.acquisition.domain.service;

import com.workflow.common.event.WorkflowStepEvent;
import com.workflow.internet.acquisition.infrastructure.messaging.publisher.WorkflowStepResponsePublisher;
import com.workflow.internet.acquisition.infrastructure.persistence.entity.StepHistoryEntity;
import com.workflow.internet.acquisition.infrastructure.persistence.mapper.StepMapper;
import com.workflow.internet.acquisition.infrastructure.persistence.repository.StepHistoryRepository;
...
public class InternetAcquisitionService {
