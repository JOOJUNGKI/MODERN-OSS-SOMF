package com.workflow.internet.equipment.domain.service;

import com.workflow.common.event.WorkflowStepEvent;
import com.workflow.internet.equipment.infrastructure.messaging.publisher.WorkflowStepResponsePublisher;
import com.workflow.internet.equipment.infrastructure.persistence.entity.StepHistoryEntity;
import com.workflow.internet.equipment.infrastructure.persistence.mapper.StepMapper;
import com.workflow.internet.equipment.infrastructure.persistence.repository.StepHistoryRepository;
...
public class InternetEquipmentService {
