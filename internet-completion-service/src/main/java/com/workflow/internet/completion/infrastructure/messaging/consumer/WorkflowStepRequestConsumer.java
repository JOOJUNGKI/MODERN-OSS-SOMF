...
package com.workflow.internet.completion.infrastructure.messaging.consumer;

import com.workflow.common.event.WorkflowStepEvent;
import com.workflow.internet.completion.domain.service.InternetCompletionService;
...
public class WorkflowStepRequestConsumer {
   ...
   private final InternetCompletionService internetCompletionService;
    ...
    public void handleInternetStepResponse(WorkflowStepEvent event) {
        ...
        try {
            internetCompletionService.doProcess(event);
